...
<aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        ...
        <i class="bi bi-box2"></i><span>Produk</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <li>
            <a href="{{route('category-content.index')}}">
    ...
    <li class="nav-item">
        ...
        <i class="bi bi-send"></i><span>Promo</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
...
<footer id="footer" class="footer">
    <div class="copyright">
    &copy; Copyright <strong><span>Digital Industry Agency</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
