    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="card info-card sales-card">
                ...
                <div class="card-body">
                <h5 class="card-title">Order Total <span>| This Month</span></h5>
            ...
            <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                <h5 class="card-title">Penjualan <span>| This Month</span></h5>
            ...
            <div class="card recent-sales overflow-auto">
                ...
                <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        {{-- Start Ulang data Recent Status --}}
                    {{-- @foreach ( as )
                    <tr>
